...
6. **Stage 3 programme (30 Aug 2026 send pack):** [`ShenRuililin_Laidlaw_Stage3Report.pdf`](../outputs/ShenRuililin_Laidlaw_Stage3Report.pdf) SHA prefix `1200082a9e7c9caa`. Send pack: [`send_pack_2026-08-30/`](../analysis_plan/send_pack_2026-08-30/). Same science as the live Discussion; Appendix Table A2 is instruments-only. Reported estimates remain Model 1; Models 2–3 specified, not fitted. Current poster (`e3f149ae2ee3f2bd`) keeps the original author row, replaces Laidlaw Scholars Programme with Professor David Bishai, and drops the collaborator footnote; the 22 Aug signed object is a different file. Form 2a signed 31 Aug against the 22 Aug foldback — hashes: [`2026-08-31_bishai_form2a_signed.md`](2026-08-31_bishai_form2a_signed.md). Do not attach the live manuscript. Gate 3 remains open.
