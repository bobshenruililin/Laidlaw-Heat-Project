...
| W03 | What is the executable Li-HW / `HM23` rule? | Event family and Hogan’s count-to-tail adaptation are known; checkbox card written 14 Aug (`reports/hogan_w03_lock_card_2026-08-14.md`). Reference period, percentile/tie method, gaps, missingness and month mapping remain **unticked**. Rank 3.92 does not close this | Hogan with Bob implementing | Hogan’s wording recorded on the Tuesday decision sheet and reflected in the registry |
...
| W07 | Is HKO Headquarters the primary exposure station, and what spatial sensitivity is feasible? | Headquarters is the working choice and remains the live-paper encoding. Exposure-only ERA5 companions now include a monthly bridge: mean Tmin travels (r = 0.986) and 28°C nights do not (slope 0.045; Jaccard 0.031). Remaining hot-night identification is intensive (Jun–Sep always on; July 1 vs 25). That measurement defends keeping Headquarters rather than swapping the instrument | Hogan | Written station choice in the live weather Methods; optional limitation sentences after Hogan has seen the cards. Do not paste ERA5 flags as HKO |
