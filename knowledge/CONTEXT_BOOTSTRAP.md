...
5. **Live manuscript:** Continuous draft is [`manuscript/live_collaborative/Heat_CVD_Manuscript_live_update.md`](../manuscript/live_collaborative/Heat_CVD_Manuscript_live_update.md) (pointer: [`manuscript/LIVE_MANUSCRIPT.md`](../manuscript/LIVE_MANUSCRIPT.md)). 15 August protocol ledgers: [`manuscript/live_collaborative/protocol_2026-08-15/`](../manuscript/live_collaborative/protocol_2026-08-15/). Shen Ruililin pastes from [`LIVE_DOC_EDITS.md`](../manuscript/live_collaborative/LIVE_DOC_EDITS.md) into Hogan’s shared file (do not email a parallel Word copy). Weather paragraph remains Hogan’s. Figure 4 and the ERA5 monthly limitation are proposed; Hogan can strike. Roro still owns health-data expansion. Stage 3 PDFs stay locked. Gap: [`2026-08-14_cns_live_quality_gap.md`](2026-08-14_cns_live_quality_gap.md). Three surfaces: [`2026-08-13_three_manuscript_surfaces.md`](2026-08-13_three_manuscript_surfaces.md). [Playbook 04](../analysis_plan/playbooks/04_final_writeup.md).
...
For the **identification laboratory** (exposure only; second-level from the instrument), use [`docs/id/`](../docs/id/) and [`2026-08-14_identification_laboratory.md`](2026-08-14_identification_laboratory.md). Jaccard 0.031 is an integral: ERA5 agrees 1/365 times in [28, 29)°C. The six-row identification profile is the paper object; the reliability curve is companion-only. Cold-side 127/128, public HKO station replicates, and WorldPop weights now live in the same room. Not form 2a. Parked close-out: [`2026-08-14_parked_object_closeout.md`](2026-08-14_parked_object_closeout.md).

Official Laidlaw Drive (HKU 2a form, Foundation outputs, 3 C’s, poster notes): [`2026-08-14_laidlaw_official_drive.md`](2026-08-14_laidlaw_official_drive.md). Research essay due **31 August 2026**; poster file **15 September**; Chi Wah week of **5 October**. Imperial conference **16–18 October 2026** (Audrey Chung, 14 Aug): spreadsheet J–O overdue; panel abstract **6 September**; T&F **24 September** optional; Imperial print is **A1**. [`2026-08-14_audrey_imperial_conference.md`](2026-08-14_audrey_imperial_conference.md). Network University-room URL is what HKU reports to the Foundation. GitHub Pages is not a substitute. **Likeliest miss:** delaying Professor Bishai’s endorsement of form 2a.
