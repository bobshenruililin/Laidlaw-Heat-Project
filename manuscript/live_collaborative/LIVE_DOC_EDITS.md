...
2. **Abstract.** Replace the yellow “work in progress” with the draft Abstract. Keep exploratory language (all twelve *q* > 0.19). The Abstract states DJF cold-day concentration, June–September hot-night intensity (July 2013, 1 night; July 2022, 25), the two lag-1 ACF values, and the pre-2020 CHD hot-night interval (1.011, 0.991–1.032) that includes 1.
...
8. **Figures (insert as images, then delete the markdown path lines if any remain).**
   ...
   - Preferred extra if a third identification figure is wanted: `figures/live_identification/figure_E_trend_depletion_sensitivity.png` (same object as `outputs/release_chd_hf/figures/figure4_trend_depletion_sensitivity.svg`). CHD hot-night interval includes 1 before 2020; HF cold-day interval strengthens. Caption: “Core count ratios across trend and first-event sensitivities (Newey–West lag-6 intervals).” Do not number this as Figure 3 or Figure D — those names are the hot-night heatmap.
...
9. **Discussion / Conclusion / limitations.** Replace “work in progress.” Keep the refusal of a protected primary claim. Bounded comparisons only: HF–cold with Goggins and Chan (2017); hot nights with Guo et al. (2024) metric distinction. The 14 August pass adds: hot-night identifying variation is summer intensity (Figure 3); ERA5 monthly mean Tmin tracks Headquarters while 28 °C-night counts do not. The 15 August pass states that archive influenza 1.673 used a general-population × days offset, not the core days-in-month offset. Do not paste HM/CM coefficients or archive flu/NO₂ as adjusted Table 2. Do not paste daily Jaccard 0.031, 449 vs 17, or 0.045 as a health attenuation factor.
...
| Leading-contrast ACF 0.508 / 0.146, now also Figure 4 | Serial dependence is part of the inferential problem; not a claim that model-based intervals are too narrow |
