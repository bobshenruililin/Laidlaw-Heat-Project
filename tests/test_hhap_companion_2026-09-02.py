...
def test_live_discussion_still_short_and_cites_s9():
    assert "Supplementary Table S9" in LIVE_TEXT
    body = LIVE_TEXT.split("## Discussion", 1)[1]
    assert "They are not a test of any alert" in body
...
def test_hogan_identification_pdf_cites_s9():
...
if __name__ == "__main__":
    for fn in (
        ...
        test_live_discussion_still_short_and_cites_s9,
        test_hhap_pdf_built,
        test_hogan_identification_pdf_cites_s9,
    ):
        fn()
