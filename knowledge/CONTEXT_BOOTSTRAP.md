...
5. **Live manuscript:** Hogan Word+PDF now exceed the 24 August Desktop snapshot (`b172ed31659d6cd6`, 14 pages). Current PDF `96b69b7b7ba38513` (22 A4); Word `852702ded2c4e968`. Short night/CHD and HF/cold hypotheses + instruments-only WHO/HK map remain. Table 2 = Model 1; Hogan HKO paragraph untouched. Word comments no longer say paste/pipeline. Model 2/3 still need a governed-panel fit. Roro still owns ICD/timing and the IRB number. Gate 3 remains open. **2 Sep adversary audit:** machine ledger 160/1 red — live body missing display string `Supplementary Table S9` (SI object still present); core numerals match; remains identification (all *q*>0.19). See [`2026-09-02_adversary_live_id_audit.md`](2026-09-02_adversary_live_id_audit.md). Scorecard: [`../reports/hogan_exceeds_20260824_snapshot.md`](../reports/hogan_exceeds_20260824_snapshot.md). Durable: [`2026-08-31_hogan_exceeds_snapshot.md`](2026-08-31_hogan_exceeds_snapshot.md).
