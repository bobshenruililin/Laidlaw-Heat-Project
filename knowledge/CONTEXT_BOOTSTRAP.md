...
5. **Live manuscript:** 24 August Hogan Methods rewrite is in [`manuscript/live_collaborative/Heat_CVD_Manuscript_live_update.md`](../manuscript/live_collaborative/Heat_CVD_Manuscript_live_update.md). Paste from [`LIVE_DOC_EDITS.md`](../manuscript/live_collaborative/LIVE_DOC_EDITS.md) (24 Aug banner first). Methods-only Word: `Heat_CVD_Methods_20260824_paste.docx`. Comment map: [`2026-08-24_hogan_pdf_comments.md`](2026-08-24_hogan_pdf_comments.md). Hogan’s 24 Aug weather paragraph is copied verbatim; do not restore the July daily-variables paragraph. Do not email a parallel Word copy. Roro still owns health-data expansion and the IRB number. 15 August pack remains provenance. If the 15 August paste is already in the live file, still **replace Methods** with the 24 August text. Seven 28 July threads: [`hogan_comment_paste_replies.md`](../manuscript/live_collaborative/hogan_comment_paste_replies.md). Figure 3 is trend/depletion sensitivity. Gate 3 remains open.
