...
| A63 | Cross-city reanalysis flags | Open-Meteo ERA5-Land is a same-source exposure grid for ranking cities; it is **not** a substitute for HKO official flags. Apparent temperature on that grid is a third encoding and does not reconstruct Headquarters hot nights | Low (4017-day calibration) | Prevents pasting 17 or 1,453 ERA5 nights into a paper that uses 449 HKO nights | Keep live paper on HKO; atlas is exposure-only | Hogan/Bob |
