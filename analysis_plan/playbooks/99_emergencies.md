...
11. **Collaborator redirects the paper angle.** Preserve the flown manuscript (copy into `manuscript/archive/…`). Do not overwrite Hogan’s shared Word in place. Open a dated new track. Record Hogan’s words separately from what the file supports. Do not treat the email as a Gate 3 freeze. Do not infer biology from a COVID contrast (case 4 still binds). Precedent: 10 Sep 2026 thermal → COVID-period (`reports/incident_2026-09-10_scientific_angle_covid.md`).
