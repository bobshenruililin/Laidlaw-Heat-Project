...
Pearson residual autocorrelation at lag 1 was 0.51–0.53 for CHD continuity models and 0.13–0.18 for HF. Ljung–Box tests at lag 6 rejected residual white noise for CHD (*p* < 10^−8^) and not for HF (*p* > 0.3). Serial dependence is part of the inferential problem for CHD.
