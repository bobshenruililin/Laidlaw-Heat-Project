...
5. **Live manuscript:** 29 August STORM physiology + HHAP paragraphs are in [`manuscript/live_collaborative/`](../manuscript/live_collaborative/). Table 2 = Model 1; Hogan HKO paragraph untouched. Physiology is hypothesis; WHO 2026 × HK bundle is mapping, not evaluation. Paste into Hogan’s shared file remains a separate human step. Model 2 still needs a governed-panel fit. Roro still owns ICD/timing and the IRB number. Gate 3 remains open. Durable: [`2026-08-29_storm_physio_hhap.md`](2026-08-29_storm_physio_hhap.md).
6. **Stage 3 programme (29 Aug 2026 rebuild):** [`ShenRuililin_Laidlaw_Stage3Report.pdf`](../outputs/ShenRuililin_Laidlaw_Stage3Report.pdf) SHA prefix `0b359b1f8527d7a7`. Same science as the live Discussion; Appendix Table A2. Model 1 / Model 2 / Model 3 language; reported estimates remain Model 1; Models 2–3 specified, not fitted. Poster unchanged (`a972206e61932650`). Form 2a is a human decision if already signed against `605cd8db43072cb5`. Do not attach the live manuscript. Gate 3 remains open. Hashes: [`send_pack_2026-08-29/HASH_VERIFY.md`](../analysis_plan/send_pack_2026-08-29/HASH_VERIFY.md).
