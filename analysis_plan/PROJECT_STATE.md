...
- Bob asked to put Professor Bishai on the front of the A0 poster, larger, and to drop Hogan and Zhenyuan Liu from the byline. Header: Shen Ruililin; **Supervisor: Professor David Bishai** at 48 pt. Footer is email only. Science and figures unchanged. Essay SHA prefix remains `1200082a9e7c9caa`.
- Current poster SHA prefix `340f39cc301622bb` (1 ISO A0 page). Note: [`knowledge/2026-09-15_stage3_poster_bishai_header.md`](../knowledge/2026-09-15_stage3_poster_bishai_header.md).
...
- Gate 3 remains **OPEN**. Stage 3 essay stays `1200082a9e7c9caa`. Poster authorship was rebuilt 15 Sep (`340f39cc301622bb`). No agent sent or pasted the package. Run note: `analysis_plan/prompts/goal_run_2026-09-10.md`.
