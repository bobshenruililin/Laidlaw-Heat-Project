...
| 2026-08-12 | Ship / Decide | Hogan asks Methods status + who shares temperature panel with Roro (deadline 12 Aug) | Sol: both CSVs OK with expanded dictionary; Bob shares (Hogan need not); one email Cc Roro; show CHD/HF estimand + Methods status only; hide results/Gate 3/CNS; paste CHD/HF Methods into live file, not stroke Aug-5 draft | Keep | hogan_aug12_methods_and_temp_email.md; hogan_aug12_shared_doc_putins.md; methods_live_paste_chd_hf_aug12.md; outputs/share_for_roro/; knowledge/2026-08-12_hogan_roro_handoff.md |
