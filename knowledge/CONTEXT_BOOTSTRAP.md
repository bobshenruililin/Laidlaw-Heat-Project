...
6. **Stage 3 programme (23 Aug 2026):** Submit [`ShenRuililin_Laidlaw_Stage3Report.pdf`](../outputs/ShenRuililin_Laidlaw_Stage3Report.pdf) (SHA prefix `c083d4096a0924b1`) and, optionally, [`ShenRuililin_Laidlaw_Stage3Poster.pdf`](../outputs/ShenRuililin_Laidlaw_Stage3Poster.pdf) (SHA prefix `0ef58e0951bb2ffd`). Form 2a **Research Topic** now matches the essay title + subtitle (AMI/stroke application title gone). Email A: **SEND** after dropping “preliminary poster”; Bishai only ([`2026-08-23_form2a_research_topic.md`](2026-08-23_form2a_research_topic.md); [`send_pack_2026-08-22/`](../analysis_plan/send_pack_2026-08-22/)). Do not attach the live manuscript. Gate 3 remains open.
