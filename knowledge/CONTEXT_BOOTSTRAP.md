...
6. **Stage 3 programme (29 Aug 2026 rebuild):** [`ShenRuililin_Laidlaw_Stage3Report.pdf`](../outputs/ShenRuililin_Laidlaw_Stage3Report.pdf) SHA prefix `f55f8f14f214bc92`. Same science as the live Discussion; Appendix Table A2. Model 1 / Model 2 / Model 3 language; reported estimates remain Model 1; Models 2–3 specified, not fitted. Poster unchanged (`a972206e61932650`). Form 2a is a human decision if already signed against `605cd8db43072cb5`. Do not attach the live manuscript. Gate 3 remains open. Hashes: [`send_pack_2026-08-29/HASH_VERIFY.md`](../analysis_plan/send_pack_2026-08-29/HASH_VERIFY.md).
