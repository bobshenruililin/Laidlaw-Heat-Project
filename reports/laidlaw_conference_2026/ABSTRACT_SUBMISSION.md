# Annual Laidlaw Scholars Conference 2026 — Research abstract

**Presenter:** Shen Ruililin (Bob).  
**Mode:** Ship. Not a Gate 3 freeze. Not a paste into Hogan’s shared live file.  
**Panel:** OpenAI lab, Jane Street identification, IAS honesty, YC meeting-product. Hybrid they all accepted: title B for the room; ambition-as-refusal spine in Q8/Q12; omit unprotected count ratios from the abstract.

Copy-paste fields: [`COPY_PASTE.md`](COPY_PASTE.md).  
Kill-list tests: `tests/test_laidlaw_conference_2026.py`.

## 8. Presentation topic

Heat, cold, and first cardiac hospitalisation in Hong Kong: ambition as refusal.

## 9. Categories (at most 3)
...
- VALUE-DRIVEN
- COLLECTIVITY
- RESISTING AND REFORMING — only in the sense of refusing a confirmatory headline from unprotected monthly counts, not reforming Hong Kong’s warnings
- SCALE
- VISION
...
## Panel constraints (binding)

| Seat | Binding |
|---|---|
| OpenAI | No confirmatory thermal effect; no “warnings work.” No Pace tick. |
| Jane Street | Omit 1.022, 1.073, and 1.113 from this abstract. No five-day trigger. |
| IAS | Q12 spare third-person. Weather sentences stay weather until the refusal lands. |
| YC | Title B for the room. Methods dump cut. Do not tick “I evaluated Hong Kong’s heat plan.” |
