...
**Assembled SI (updated 10 September):** [`supplement_live_track.md`](supplement_live_track.md). Rebuild with `python3 scripts/51_build_live_track_supplement.py`.  
...
| **Supplementary Table S10** | Weather summaries for 2013–2019, 2020–2022, and 2023 | `outputs/share_for_roro/temperature_monthly_panel_2013_2023.csv` | `REAL`; exposure context only |
| **Supplementary Note S1** | Prior thermal, physiological, and policy context | cited papers [1–5,12,13,17,21,23–33] | Cited context; no measured mechanism |
