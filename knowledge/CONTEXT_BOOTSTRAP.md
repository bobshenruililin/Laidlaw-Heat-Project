...
For the **identification laboratory** (exposure only; second-level from the instrument), use [`docs/id/`](../docs/id/) and [`2026-08-14_identification_laboratory.md`](2026-08-14_identification_laboratory.md). Jaccard 0.031 is an integral: ERA5 agrees 1/365 times in [28, 29)°C. The six-row identification profile is the paper object; the reliability curve is companion-only. Not form 2a.
