# Sol YC mentorship — 14 August 2026

**Mode:** Decide + packing honesty. No action from Bob today.
...
## 2. Seventeen-day packing ladder: 15–31 August

The 31 August objects are the endorsed local 2a and unchanged essay. Professor Bishai’s signature is the serial risk.

| Slot | Who | Hours | Done when | Do not mix |
|---|---|---:|---|---|
| 15 Aug, first | Bob | 0.75 | A local official 2a contains only Bob-verified fields, Bob’s signature and actual date; Bishai’s assessment block is blank. | No invented UID, year, attachment dates, comments or signature; no 2b. |
| 15 Aug, second | Bob | 0.25 | **Email A** sends the local 2a and frozen essay (`6136e85a654502a0…`) to Bishai with one endorsement ask. | No maps, figure, poster, manuscript, demo or product link. |
...
## 3. “Outstanding” for the public companion

Outstanding is **one hallway**, not six entrances: four Leaflet rooms with shared language and one stable front door. It is **one SVG instrument**, not a fifth map: move the threshold, preserve source and state, and inspect exact cached values. It is **one citable figure**: use the shipped composite, not a new gallery. It is **disagreement-nights you can step through**: station Tmin, grid Tmin, apparent temperature and Waglan on the same real date, with flags shown but no harm narrative.

The companion remains exposure-only. It carries no hospital layer, transported ratio, “corrected” thermometer, health attenuation, scrollytelling, six-link tour or method-count boast. All core *q* > 0.19; Gate 3 remains open; no coefficient is the ending.

## 4. Resource conflict rule

If anything competes with Bishai’s 2a—including the companion, Pages, Email B, the Network post, the manuscript or agent surprise-work—the 2a wins without discussion.
