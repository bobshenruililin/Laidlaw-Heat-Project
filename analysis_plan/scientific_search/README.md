# Scientific search (compounding layer)

Playbook 05 is a Jin-shaped *round*. This directory is what must not return to zero when the round, or the paper, ends.

| File | Role |
|---|---|
| [`CONSTITUTION.md`](CONSTITUTION.md) | Production function, rails, width × depth × cycle, compounding contract |
...
python3 scripts/test_60_scientific_search_cycle.py
```

Do not paste into Hogan’s live file. Do not freeze Gate 3. Do not overwrite the weather paragraph. Do not rebuild Stage 3 PDFs.
