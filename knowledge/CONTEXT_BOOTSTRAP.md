...
5. **Live manuscript:** Hogan Word+PDF exceed the 24 August Desktop snapshot (`b172ed31659d6cd6`, 14 pages). After the 2 Sep S9 restore: PDF `306e084824de6b0e` (22 A4); Word `afff1fcc7b079e1f`. Claim-ledger auditor **161/0**. Short night/CHD and HF/cold hypotheses + instruments-only WHO/HK map remain. Table 2 = Model 1; Hogan HKO paragraph untouched. Model 2/3 still need a governed-panel fit. Roro still owns ICD/timing and the IRB number. Gate 3 remains open. **HHAP companion (not a paste into Discussion):** [`manuscript/hhap/who2026_hong_kong_instrument_map.md`](../manuscript/hhap/who2026_hong_kong_instrument_map.md), PDF `71b1073ab3b93ee9` (5 A4). Mapping, not evaluation. Durable: [`2026-09-02_autoresearch_hhap_paper.md`](2026-09-02_autoresearch_hhap_paper.md). Scorecard: [`../reports/hogan_exceeds_20260824_snapshot.md`](../reports/hogan_exceeds_20260824_snapshot.md).
