...
| `/playbook-06-scientific-search` | Compounding scientific-search harness. Does not freeze Gate 3 or rewrite Hogan weather. |
...
Playbook **06** is [`06_scientific_search.md`](../../analysis_plan/playbooks/06_scientific_search.md). Do not reuse the number.
