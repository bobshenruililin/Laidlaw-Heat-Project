...
## 12. Live Discussion physiology + HHAP (29 August 2026)

The live manuscript now carries the night/CHD and cold/HF hypotheses in Hogan register, plus a WHO 2026 eight-element mapping onto Hong Kong’s HKO/DH/HAD bundle. Ashe et al. 2025 (three studies; mixed blood pressure) blocks a dipping theorem. Ikäheimo 2018 and Li et al. 2026 support an afterload hypothesis for HF, not an imported Goggins magnitude. The mapping does not evaluate warnings. Packet: [`reports/storm_physio_hhap_2026-08-29/`](../reports/storm_physio_hhap_2026-08-29/). Durable: [`knowledge/2026-08-29_storm_physio_hhap.md`](../knowledge/2026-08-29_storm_physio_hhap.md).
