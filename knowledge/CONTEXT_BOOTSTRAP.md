...
6. **Stage 3 programme (20 Aug 2026):** Email A to Bishai is drafted in [`send_pack_2026-08-20/`](../analysis_plan/send_pack_2026-08-20/). Bob fills form 2a, sends, and pastes spreadsheet Q/R. Hogan adding TV to the temperature panel does not delay that note. Written dissemination authority remains a PI line inside Email A, not a separate manifesto.
