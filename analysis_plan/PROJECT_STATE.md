...
- Actual trip is a **HKG–LHR–HKG** return out **13/14/15 Oct**, back **23 Oct**, plus a self-funded LHR–VLC–LHR hop (18 Oct out; **23 Oct morning** back, then CX250 18:20 or BA31 19:20). Hotel booked. 13–23 is the right route, not the circular 15/18 dates. Whether they pay HK$8,000 of an over-cap CX nonstop (~US$1,079) is unwritten; 15/18 1-stop is still ~US$750. See [`../reports/horizons_uk_conference_2026/definition_13_23_and_self_transfer.md`](../reports/horizons_uk_conference_2026/definition_13_23_and_self_transfer.md).
