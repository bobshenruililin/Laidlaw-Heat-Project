...
def build_docx() -> None:
    ...
    for para in [
        ...
        "The two residual signals are sensitive to the time trend in opposite directions. The CHD hot-night interval includes 1 under a stiffer 3-df spline (1.011, 0.990–1.032). It excludes 1 under the 6-df and 8-df splines (1.024, 1.005–1.044; 1.023, 1.005–1.042). The year-indicator interval has the highest point estimate of the trend checks and includes 1 (1.025, 0.9998–1.050). The HF cold-day interval includes 1 under the most flexible 8-df spline (1.062, 0.994–1.135). That pattern concerns how the first-event decline and monthly thermal burden share one time smooth. The spline degrees of freedom are a model setting, and they do not describe a physiological duration.",
