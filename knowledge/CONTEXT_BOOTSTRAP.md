...
5. **Live manuscript:** 24 August Hogan Methods rewrite is in [`manuscript/live_collaborative/`](../manuscript/live_collaborative/) (`Heat_CVD_Manuscript_live_update.md`, `hogan_20260824_comment_inventory.md`). Paste from [`LIVE_DOC_EDITS.md`](../manuscript/live_collaborative/LIVE_DOC_EDITS.md) into the shared file (do not email a parallel Word copy). Leave Hogan’s HKO weather paragraph. Reply to 24 Aug KW balloons from [`hogan_20260824_paste_replies.md`](../manuscript/live_collaborative/hogan_20260824_paste_replies.md) and keep the seven 28 July threads from [`hogan_comment_paste_replies.md`](../manuscript/live_collaborative/hogan_comment_paste_replies.md). Do not resolve until he has read the replies. Table 2 still needs a governed-panel refit with RH and rainfall. Roro still owns ICD/timing and the IRB number. Figure 3 is trend/depletion sensitivity. Gate 3 remains open.
