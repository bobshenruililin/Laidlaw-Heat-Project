...
- Named quote (not purchased): CX255 **12 Oct 23:15** → LHR 13 Oct 06:20; CX254 **23 Oct 22:15** → HKG 24 Oct 18:00; Economy Light with 1×23 kg; published **HK$8,455**, Miles Plus Cash **HK$7,999** + 8,300 Asia Miles. That is the cheapest **Cathay nonstop** Bob found, not a proven 15/18 lowest-economy comparator. Send the itinerary follow-up; do not buy until they write. File: [`../reports/horizons_uk_conference_2026/cx_quote_2026-08-22.md`](../reports/horizons_uk_conference_2026/cx_quote_2026-08-22.md).
