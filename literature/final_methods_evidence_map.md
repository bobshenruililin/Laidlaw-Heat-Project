...
| Guo et al. 2016 (`guo2016tv`; DOI 10.1289/EHP149; PMID 27258598) | TV = sample SD of daily Tmin and Tmax over lags 0–k (TV0–1, TV0–7); continuous daily mortality exposure, not a binary date | Climate share-panel columns after Jingjing’s 20 Aug 2026 request. Operator locked; monthly collapse is a project translation | Mortality TV RRs are not monthly CHD/HF count ratios. Not P15 (mean diurnal range). Not a core exposure unless Hogan writes it into the live weather Methods |
| Guo et al. 2024 (`guo2024hotnights`; DOI 10.1016/j.lanwpc.2024.101168) | Hot-night *excess* associated with hospitalisation; official binary HNday28 often null. Cite Table 3 for the per-10 °C·h CI (0.2–3.5%); Results prose prints 3.6%. Abstract NCNE n = 5,002,114 | Retain official HN counts while examining intensity/persistence separately | Broad hospitalisation, not diagnosis-specific monthly first events. Do not mix 3.1% extreme HNe with 4.3% circulatory per 10 °C·h. |
| Chau / Pun et al. 2025 (`chau2025gerontol`; DOI 10.1093/gerona/glaf002) | HK hospitalisations 2012–2018, age ≥65; 3 consecutive very hot days: CVD RR 1.09 (1.03–1.14) lag 4 community-dwelling; 1.28 (1.05–1.54) lag 18 old-age-home | Parked local heat–morbidity sibling using official HKO flags | Case-crossover, age-restricted, daily. Not our monthly first-event count ratio. |
| EcoEnv 2025 (`ecoenv2025circ`; DOI 10.1016/j.ecoenv.2025.117827) | Circulatory emergency admissions 2004–2019; temperature AF 7.98% (5.24–10.58%), mostly cold | Parked local cold–circulatory AF complement to Liu 2020 mortality AFs | All-age EHA AF ≠ T2D/HTN first-hospitalisation count ratio. |
| Tian / Qiu / Sun / Lin 2016 (`tian2016circoutcomes`; DOI 10.1161/circoutcomes.115.002410) | Circulatory EHA 2005–2012; cold AF 6.33% + 0.82%; no apparent heat effect | Parked older local cold-morbidity AF | Earlier decade; not first-event CHD/HF. |
