...
5. **Live manuscript:** 24 August Hogan Methods rewrite is in [`manuscript/live_collaborative/`](../manuscript/live_collaborative/). Committee merge of PR 69 + PR 70: [`COMMITTEE_VERDICT_PR69_vs_PR70.md`](../manuscript/live_collaborative/COMMITTEE_VERDICT_PR69_vs_PR70.md). **Print copy for Bishai (27 Aug):** `Heat_CVD_Manuscript_20260824_hogan.pdf` (banner removed; tables unsplit; SHA prefix `436fb4ff1b278ec8`). Nested Model 1 / Model 2 / Model 3; Table 2 = Model 1; equation (1); present-tense Model 2/3. Leave Hogan’s HKO weather paragraph. Paste into Hogan’s shared file remains a separate human step. Model 2 still needs a governed-panel fit. Roro still owns ICD/timing and the IRB number. Gate 3 remains open.
6. **Stage 3 programme (24 Aug 2026):** Submit [`ShenRuililin_Laidlaw_Stage3Report.pdf`](../outputs/ShenRuililin_Laidlaw_Stage3Report.pdf) and, optionally, [`ShenRuililin_Laidlaw_Stage3Poster.pdf`](../outputs/ShenRuililin_Laidlaw_Stage3Poster.pdf). Model 1 / Model 2 / Model 3 language; reported estimates remain Model 1; Models 2–3 specified, not fitted. Send pack: [`send_pack_2026-08-24/`](../analysis_plan/send_pack_2026-08-24/). Hashes: [`HASH_VERIFY.md`](../analysis_plan/send_pack_2026-08-24/HASH_VERIFY.md). Memo: [`2026-08-24_stage3_hogan_align.md`](2026-08-24_stage3_hogan_align.md). Do not attach the live manuscript. Gate 3 remains open.
7. **Fukuda brief (28 Aug 2026, parallel, not Gate 3):** a 12-week health-security translation of the exploratory HK panel. Audit: [`2026-08-28_portfolio_audit_fukuda.md`](2026-08-28_portfolio_audit_fukuda.md). Pack: [`reports/fukuda_pitch/`](../reports/fukuda_pitch/). Do not invent Gansu/Medellín field results. ESF geography is GBA/Mainland. Agents do not email Fukuda.
8. **Submission gates (journal):** PI IRB decision, ICD/inpatient semantics, authorship/order, and cohort risk-set decision. Gate 3 remains open.
9. **Final packet:** integrated report in
