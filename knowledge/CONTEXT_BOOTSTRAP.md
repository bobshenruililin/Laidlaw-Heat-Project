...
5. **Live manuscript:** 29 August STORM physiology + HHAP paragraphs were cut after an objective WORSE/MIXED audit. Short hypothesis + instruments-only mapping remain. Table 2 = Model 1; Hogan HKO paragraph untouched. Paste into Hogan’s shared file remains a separate human step. Model 2/3 still need a governed-panel fit. Roro still owns ICD/timing and the IRB number. Gate 3 remains open. Durable: [`2026-08-29_storm_physio_hhap.md`](2026-08-29_storm_physio_hhap.md); audit: [`../reports/objective_audit_physio_hhap_2026-08-29.md`](../reports/objective_audit_physio_hhap_2026-08-29.md).
6. **Stage 3 programme (29 Aug 2026 rebuild):** [`ShenRuililin_Laidlaw_Stage3Report.pdf`](../outputs/ShenRuililin_Laidlaw_Stage3Report.pdf). Same science as the live Discussion; Appendix Table A2 is instruments-only. Model 1 / Model 2 / Model 3 language; reported estimates remain Model 1; Models 2–3 specified, not fitted. Poster unchanged (`a972206e61932650`). Form 2a is a human decision if already signed against `605cd8db43072cb5`. Do not attach the live manuscript. Gate 3 remains open. Drop-in for Model 2/3: [`send_pack_2026-08-29/MODEL2_MODEL3_DROPIN.md`](../analysis_plan/send_pack_2026-08-29/MODEL2_MODEL3_DROPIN.md).
...
Use the explicit slash skills `/playbook-01-hogan-lock`, `/playbook-02-ha-arrival`, `/playbook-03-full-analysis`, `/playbook-04-final-writeup`, `/playbook-05-auto-research`, `/playbook-07-pr-board`, `/playbook-08-health-econ-lab`, `/objective-audit`, or `/playbook-99-emergencies`; `/playbook` asks which one. Playbook 06 lives on PR #68. Generic TWFE/Callaway/QALY advice is Playbook 08 only, never the live file. DUA: `.cursorignore`. Open-PR board: [`reports/pr_board_latest.md`](../reports/pr_board_latest.md). Each skill reads the canonical playbook and cannot replace human evidence or gate ownership. See the [command contract](2026-07-26_commands_and_blog_auto.md). Auto-research lab: [`analysis_plan/playbooks/05_auto_research_lab.md`](../analysis_plan/playbooks/05_auto_research_lab.md) and [`2026-08-16_auto_research_lab.md`](2026-08-16_auto_research_lab.md).
