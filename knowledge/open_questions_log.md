...
| W07 | Is HKO Headquarters the primary exposure station, and what spatial sensitivity is feasible? | Headquarters is the working choice and remains the live-paper encoding. Exposure-only ERA5 companions now exist (0.1° HK lattice; 0.2° PRD mosaic; 16-city atlas; PRD field laboratory with EOF/harmonics) but are **not** a silent station swap | Hogan | Written station choice and any fixed sensitivity specification |
