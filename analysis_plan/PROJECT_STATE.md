...
| **Prof. David Bishai** | Dec 2025 plan; multi-method; teamwork (“go far together”); Jasmine null-pattern / extend-to-2023; ~10°C discussion prompt | Confirm which paper is “Jasmine’s” |
...
- **Jasmine extension:** definition-harmonised through 2023 once paper confirmed (`jasmine_extension_protocol.md`; candidates in `literature/jasmine_paper_candidates.md`). Gene/~10°C = discussion hypothesis only.
...
- Closing nudge to Hogan + Roro + Bishai (Jasmine ID) with `:)` .
