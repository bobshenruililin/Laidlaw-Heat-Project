...
6. **Stage 3 programme (29 Aug 2026 rebuild authorised):** same science as the live Discussion in the accessible essay; Appendix Table A2. Model 1 / Model 2 / Model 3 language; reported estimates remain Model 1; Models 2–3 specified, not fitted. 24 August SHA prefix `605cd8db43072cb5` is superseded when the XeLaTeX PDF is rebuilt. Form 2a is a human decision if already signed against the 24 August file. Do not attach the live manuscript. Gate 3 remains open.
