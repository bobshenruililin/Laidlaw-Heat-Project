...
| W07 | Is HKO Headquarters the primary exposure station, and what spatial sensitivity is feasible? | Headquarters is the working choice and remains the live-paper encoding. Exposure-only ERA5 companions now include a monthly bridge: mean Tmin travels (r = 0.986) and 28°C nights do not (slope 0.045; Jaccard 0.031). That measurement defends keeping Headquarters rather than swapping the instrument | Hogan | Written station choice in the live weather Methods; optional limitation sentence after Hogan has seen the card. Do not paste ERA5 flags as HKO |
