...
5. **Live manuscript:** 24 August Hogan Methods rewrite is in [`manuscript/live_collaborative/`](../manuscript/live_collaborative/). Committee merge of PR 69 + PR 70: `COMMITTEE_VERDICT_PR69_vs_PR70.md`. Paste `Heat_CVD_Manuscript_20260824_hogan.docx` into the shared file (do not email a competing copy unless Hogan asks). Nested Model 1 / Model 2 / Model 3; Table 2 = Model 1; equation (1); present-tense Model 2/3. Leave Hogan’s HKO weather paragraph. Reply to 24 Aug KW balloons from [`hogan_20260824_paste_replies.md`](../manuscript/live_collaborative/hogan_20260824_paste_replies.md). Model 2 still needs a governed-panel fit. Roro still owns ICD/timing and the IRB number. Gate 3 remains open.
