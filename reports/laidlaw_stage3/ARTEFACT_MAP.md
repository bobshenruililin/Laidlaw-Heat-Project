...
| `reports/lsn/research_project_summary.md` and `docs/lsn/` | Laidlaw Scholar Network | Draft; 5 August framing requires review | Revise before posting. Keep the companion exposure-only and use a stable public link. |
