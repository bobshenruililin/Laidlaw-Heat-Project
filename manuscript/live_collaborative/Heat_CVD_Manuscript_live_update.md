...
**Figure 3. Residual autocorrelation after month and trend.** Lag-1 autocorrelation is 0.508 for the CHD hot-night model and 0.146 for the HF cold-day model. Dashed lines are ±1.96/√132. Provenance: REAL residuals from already-fitted continuity models.
...
Strengths include a complete twelve-contrast panel, an explicit standard-error ladder, source-documented official extreme-day thresholds, identification displays for cold-day support and first-event depletion, and a refused daily-recovery analysis.
