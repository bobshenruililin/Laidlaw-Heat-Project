...
Priority order. Update status as items close. Do not manufacture work.

| # | Item | Status | Next action |
|---|---|---|---|
| 1 | Manuscript integrity and Hogan comment disposition | **Done this pass** | Bob pastes; Hogan may strike |
| 2 | Reproducibility and methods consistency | **Logged** | Panels absent; Table 2/3 match; `verify_live_numbers.py` PASS |
| 3 | Evidence and citation verification | **Done this pass** | Primary sources + [22] attached; [3] and [5] Hogan-owned unused |
