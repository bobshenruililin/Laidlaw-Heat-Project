...
| D07 | What ethics/governance determination applies to the current aggregate use? | PI decision remains open. Email A (20 Aug pack) asks one line on whether disclosure-minimised results may go to laidlaw@hku.hk after endorsement; that does not close IRB. | Bishai | Written PI/governance determination and any required protocol update |
