...
5. **Live manuscript:** 15 August CNS-register paste pack is in [`manuscript/live_collaborative/`](../manuscript/live_collaborative/). Shen Ruililin pastes from [`LIVE_DOC_EDITS.md`](../manuscript/live_collaborative/LIVE_DOC_EDITS.md) into Hogan’s shared file (do not email a parallel Word copy). Weather paragraph remains Hogan’s. Roro still owns health-data expansion. Figure 3 is trend/depletion sensitivity. Three surfaces: [`2026-08-13_three_manuscript_surfaces.md`](2026-08-13_three_manuscript_surfaces.md). Team merge: [`2026-08-15_cns_paper_team.md`](2026-08-15_cns_paper_team.md). [Playbook 04](../analysis_plan/playbooks/04_final_writeup.md) prose only — Gate 3 remains open.
