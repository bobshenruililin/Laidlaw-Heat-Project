...
**Canon date:** 31 August 2026. Read [`PROJECT_STATE.md`](../analysis_plan/PROJECT_STATE.md), [`2026-08-31_stage3_horizons_submit.md`](2026-08-31_stage3_horizons_submit.md), [`2026-08-16_auto_research_lab.md`](2026-08-16_auto_research_lab.md), [`2026-08-15_cns_paper_team.md`](2026-08-15_cns_paper_team.md), and [`2026-08-10_cns_final_reanalysis.md`](2026-08-10_cns_final_reanalysis.md) for living detail. Update this file whenever a human gate changes.
...
6. **Stage 3 programme (31 Aug 2026):** Submit the endorsed HKU form and the **22 August** essay Bob uploaded with it (`c083d4096a0924b1`), optionally with the A0 poster (`0ef58e0951bb2ffd`). Pack: [`send_pack_2026-08-31/`](../analysis_plan/send_pack_2026-08-31/). Memo: [`2026-08-31_stage3_horizons_submit.md`](2026-08-31_stage3_horizons_submit.md). Do not attach the live manuscript. The 24 August Hogan-aligned PDFs on `main` (`605cd8db43072cb5`) are the repo current essay, not the default Horizons object. Gate 3 remains open.
