...
| D07 | What ethics/governance determination applies to the current aggregate use? | **Stage 3 programme path closed 31 Aug:** form 2a signed satisfactory; Horizons may receive the examined essay. **IRB / journal path still open.** Signing form 2a is not `UW XX-XXX` and not Gate 3. | Bishai | Written PI/governance determination and any required protocol update for journal use |
