#!/usr/bin/env python3
"""PARKED — parallel 15 August Word builder. Do not run against the live file.

Salvaged from draft PR #55 and renumbered off scripts/49 (atlas spatial field).

This script hardcodes a second manuscript: Figure 3 = trend/depletion forest,
CHD-versus-HF ranking language, and an invented 'none' competing-interest
sentence. Protocol Round B reversed those choices. Journal authority is
manuscript/live_collaborative/Heat_CVD_Manuscript_live_update.md.

Do not email a Word copy. If a local .docx is needed, rewrite this builder
from the Round B markdown; do not execute this file as-is.

Historical Figure 3 PNG lives at
figures/live_identification/figure_E_trend_depletion_sensitivity.png.
"""
from __future__ import annotations

raise SystemExit(
    "PARKED: scripts/64_build_live_collab_docx.py must not run against the "
    "Round B live manuscript. See manuscript/cns_team/README.md."
)
...
FIGS = {
    ...
    2: ROOT / "figures/live_identification/figure_A_cold_day_identification.png",
        3: ROOT / "figures/live_identification/figure_E_trend_depletion_sensitivity.png",
}
