...
| KW14 | RH and rainfall in the weather list | Include / take this data as well. | Model 2 adds monthly mean RH [21] and monthly total rainfall [22] (Chan et al. 2013 BLT; rainfall as hypothesized attendance deterrent). Table 2 reports Model 1. | SPECIFICATION SATISFIED; MODEL 2 REFIT BLOCKED (no governed panel; run `scripts/53_hogan_models_rh_rain.R`) |
