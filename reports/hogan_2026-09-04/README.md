...
**Bob only:** [`TALKING_POINTS.md`](TALKING_POINTS.md), [`APPENDIX_SCORECARD.md`](APPENDIX_SCORECARD.md), [`APPENDIX_NEIGHBOURS.md`](APPENDIX_NEIGHBOURS.md), [`AGENT_OWNED_SHORTEN.md`](AGENT_OWNED_SHORTEN.md), [`mechanism_review/REVIEW.pdf`](mechanism_review/REVIEW.pdf) (500–1000 words per point; do not send to Hogan).
