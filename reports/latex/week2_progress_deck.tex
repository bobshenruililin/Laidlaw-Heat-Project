  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        ...
        \item Jasmine signal; extend definitions to 2023
      \end{itemize}
      \vspace{0.55em}
...
\begin{frame}{What each person still unlocks}
  ...
  \vspace{0.1em}
  \footnotesize
  {\color{LaidlawTeal}\textbf{Hogan:}} final weather / heatwave / hot-month / cold-month operationalisation.\\
  {\color{LaidlawTeal}\textbf{Roro:}} stroke aggregates --- first GOPC mention $\to$ true event month; dictionary; transfer.\\
  {\color{LaidlawTeal}\textbf{Dr Bishai:}} confirm which paper is ``Jasmine's'' before we call anything a replication.\\
...
\begin{frame}[plain]
  ...
  \footnotesize
  \begin{itemize}
    \item \textbf{Dr Bishai:} which paper is ``Jasmine's,'' and which table holds the
      hotter-null / colder-signal pattern?
    \item \textbf{Hogan:} shall we lock the heatwave / hot-month definitions together
      (including your count$\to$upper-tail idea, and the cold-month starters)?
